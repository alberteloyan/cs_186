...
public class Tuple implements Serializable {
	...
	public RecordId recordId = null; // not sure when we will need this yet but I included it for the sake of tracking a recordID for the methods below
